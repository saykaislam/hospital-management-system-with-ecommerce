...
@section('title', 'Doctor Speciality')
@push('css')
    {{--custom css--}}
@endpush
@section('content')
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-7 col-auto">
                            <h3 class="page-title">Doctor Speciality</h3>
                            <ul class="breadcrumb">
...
{{--                                            <th>Doctor Department Slug</th>--}}
                                        ...
                                        <tbody>
                                        @foreach($doctor_departments as $key => $doctor_department)
                                        <tr>
                                            <td>#{{$key + 1}}</td>
                                            <td>{{$doctor_department->name}}</td>
{{--                                            <td>{{$doctor_department->slug}}</td>--}}
                                            <td class="text-right">
                                                <div class="actions">
                                                    <a class="btn btn-sm bg-success-light" href="{{route('admin.DoctorSpeciality.edit',$doctor_department->id)}}">
...
{{--                                                    </a>--}}
                                                ...
                                                <div class="modal fade" id="delete_modal" aria-hidden="true" role="dialog">
                                                    <div class="modal-dialog modal-dialog-centered" role="document" >
                                                        <form method="post" action="{{route('admin.DoctorSpeciality.destroy',$doctor_department->id)}}">
                                                            @method('DELETE')
                                                            @csrf
