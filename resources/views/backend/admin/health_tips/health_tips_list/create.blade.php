...
@section('title', 'Health Tips create')
@push('css')
    {{--custom css--}}
@endpush
@section('content')
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Health Tips Create</h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Create a New Tips</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{route('admin.health-tips-list.store')}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="title_bangla" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea id="editor1" class="form-control" name="contents"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">Health Tips Content in Bangla</label>
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="content_bangla"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
