...
@section('title', 'Service Provider Category create')
@push('css')
    {{--custom css--}}
@endpush
@section('content')
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Service Provider Category Create</h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Service Provider Category Create</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{route('admin.serviceProviderCategory.store')}}" enctype="multipart/form-data" method="post">
                                    @csrf
