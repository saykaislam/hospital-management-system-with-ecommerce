    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Admin Shop</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Admin Shop</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form role="form" id="choice_form" action="{{route('admin.shop.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                                ...
                                @if(empty($shop_set))
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-info card-outline">
                                            <p class="pl-2 pb-0 mb-0 bg-info">Admin Shop Settings</p>

                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="name">Shop Name</label>
                                                    <input type="text" class="form-control" name="name" value="" id="name">
                                                    <input type="hidden" class="form-control" name="shop_id" value="" id="shop_id">
                                                </div>

                                                <div class="form-group">
                                                    <label for="bksearch">Shop Address</label>
                                                    <div class="form-group form-group--style-1">
                                                        <input type="text" class="form-control bksearch {{ $errors->has('bksearch') ? ' is-invalid' : '' }}" value="" placeholder="Enter Your Shop Address" name="bksearch">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="shipping_time" value="" id="shipping_time">
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-info card-outline">
                                            <div class="form-group pl-3 pr-3">
                                                ...
                                                <input type="text" class="form-control" name="meta_title" id="meta_title" value="" placeholder="Meta Title">
                                            </div>
                                            <div class="form-group pl-3 pr-3">
                                                <label for="meta_description">Meta Description </label>
                                                <textarea name="meta_description" id="meta_description" rows="4"  class="form-control"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label ml-3">Logo <small class="text-danger">(Size: 120 * 120px)</small></label>
                                                <div class="ml-3 mr-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-info card-outline">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="name">Shop Name</label>
                                                    <input type="text" class="form-control" name="name" value="{{ $shop_set->name }}" id="name">
                                                    <input type="hidden" class="form-control" name="shop_id" value="{{ $shop_set->id }}" id="shop_id">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="bksearch">Shop Address</label>
                                                    <div class="form-group form-group--style-1">
                                                        <input type="text" class="form-control bksearch {{ $errors->has('bksearch') ? ' is-invalid' : '' }}" value="{{ $shop_set->address }}" placeholder="Enter Your Shop Address" name="bksearch">
                                                    </div>
                                                    <div class="bklist"></div>
                                                </div>
                                                <div class="form-group">
