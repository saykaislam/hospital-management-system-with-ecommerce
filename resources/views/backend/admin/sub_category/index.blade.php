            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-sm-5 col">
                        <a href="{{route('admin.subcategory.create')}}" class="btn btn-primary float-right mt-2">Add New</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                                ...
                                <table id="order" class="table  " style="width:100%;overflow-x:auto;">
                                    ...
                                    @foreach($subcategories as $key => $cat)
                                        <tr>
                                            ...
                                            <td>{{$cat->slug}}</td>
                                            <td>
                                                <a class="btn btn-info waves-effect" href="{{route('admin.subcategory.edit',$cat->id)}}">
