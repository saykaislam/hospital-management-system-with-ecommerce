...
@section('title','Sub Sub Category Create')
@push('css')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="page-title">Add SubSubCategory</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body custom-edit-service">
                            <!-- Add Medicine -->
                            <form role="form" class="dc-formtheme dc-userform" method="post" action="{{route('admin.subsubcategory.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    <fieldset>
                                        <div class="form-group">
                                            <label for="category">SubSubCategory Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="SubSubCategory Name">
                                        </div>
                                        <div class="form-group">
