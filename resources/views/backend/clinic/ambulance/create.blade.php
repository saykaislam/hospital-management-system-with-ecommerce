...
@section('title', 'Create Ambulance')
@push('css')
@endpush
@section('content')
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Ambulance Create</h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Ambulance Create</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{route('clinic.ambulance.store')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea id="editor1" class="form-control" name="details"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
