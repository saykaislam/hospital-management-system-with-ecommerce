                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('doctor.question.answer.store')}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">Answer<span class="text-danger">*</span></label>
                                        <div class="col-md-10">
                                            <input type="hidden" name="question_id" value="{{$question->id}}">
                                            <input type="hidden" name="answer_doctor_user_id" value="{{$answer_user_id}}">
