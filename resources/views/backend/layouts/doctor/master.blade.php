...
<head>
    ...
    <!-- Datetimepicker CSS -->
    <link rel="stylesheet" href="{{asset('backend/user/css/bootstrap-datetimepicker.min.css')}}">
    <!-- Slick CSS -->
    <link rel="stylesheet" href="{{asset('backend/user/css/slick.css')}}">
    <link rel="stylesheet" href="{{asset('backend/user/css/slick-theme.css')}}">

    <!-- Daterangepikcer CSS -->
    <link rel="stylesheet" href="{{asset('backend/user/plugins/daterangepicker/daterangepicker.css')}}">
...
<div class="wrapper">
    ...
    <!-- Header Start -->
    @include('backend.includes.doctor-header')
    <!--Header End-->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-5 col-lg-4 col-xl-3 theiaStickySidebar">
                    ...
                    <!-- Sidebar Start -->
                    @include('backend.includes.doctor-sidebar')
                    <!--Sidebar End-->
...
<!-- Sticky Sidebar JS -->
<script src="{{asset('backend/user/plugins/theia-sticky-sidebar/ResizeSensor.js')}}"></script>
<script src="{{asset('backend/user/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js')}}"></script>

<!-- Circle Progress JS -->
<script src="{{asset('backend/user/js/circle-progress.min.js')}}"></script>

<!-- Slick JS -->
<script src="{{asset('backend/user/js/slick.min.js')}}"></script>
<!-- Datetimepicker JS -->
<script src="{{asset('backend/user/js/moment.min.js')}}"></script>
<script src="{{asset('backend/user/js/bootstrap-datetimepicker.min.js')}}"></script>
<!-- Daterangepikcer JS -->
<script src="{{asset('backend/user/plugins/daterangepicker/daterangepicker.js')}}"></script>
