                	...
                	@endphp
                		<tr>
                            ...
                            @if ($flash_deal_product != null)
                                ...
                                <td>
                                    <select class="form-control" name="discount_type_{{ $id }}">
                                        <option value="Flat" <?php if($flash_deal_product->discount_type == 'Flat') echo "selected";?> >৳</option>
                            ...
                            @else
                                ...
                                <td>
                                    <select class="form-control" name="discount_type_{{ $id }}">
                                        <option value="Flat" <?php if($product->discount_type == 'Flat') echo "selected";?> >৳</option>
