                                ...
                                <div class="form-group col-md-6">
                                    <div id="demo-dp-range">
                                        ...
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" class="form-control" name="start_date" autocomplete="off" value="{{ date('m/d/Y', $flash_deal->start_date_time) }}" required>
                                            <span class="input-group-addon">To</span>
                                            <input type="text" class="form-control" name="end_date" autocomplete="off" required value="{{ date('m/d/Y', $flash_deal->end_date_time) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mb-3 col-sm-12">
                                    ...
                                    <div class="">
                                        <select name="products[]" id="products" class="form-control demo-select2" multiple required data-placeholder="Choose Products">
                                            @foreach(\App\Product::where('role_id',roleId(Auth::id()))->where('user_id',Auth::id())->get() as $product)
                                                @php
