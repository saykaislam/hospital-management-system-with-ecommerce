...
<!-- Sidebar -->
    <div class="sidebar" >
        ...
        <div class="user-panel mt-3 pb-2 pl-2 mb-2 d-flex">
            <div class="">
                <img src="{{asset('uploads/profile_pic/vendor/'.Auth::user()->image)}}" class="" alt="User Image" width="100%">
            </div>
            {{--<div class="info">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    ? 'menu-open' : ''}}">
                        ...
                        @php
                            ...
                            $new_orders = \App\Order::where('shop_id',$shop->id)->where('delivery_status','Pending')->where('view',0)->count();
                        @endphp
...
{{--                        </li>--}}
                        ...
                        <li class="nav-item">
                            ...
                            <a href="{{route('seller.shop.manage')}}" class="nav-link {{Request::is('seller/shop/manage*') ? 'active' :''}}">
