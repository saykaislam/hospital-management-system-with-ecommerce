...
@push('css')
    <link rel="stylesheet" href="{{asset('backend/seller/plugins/datatables/dataTables.bootstrap4.css')}}">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                @if($userInfo->avatar_original != null)
                                ...
                                @elseif(Auth::user()->image != null)
                                    <img class="profile-user-img img-fluid img-circle" src="{{asset('uploads/profile_pic/vendor/'.Auth::user()->image)}}" alt="User profile picture">
                                @else
                                    <img class="profile-user-img img-fluid img-circle" src="{{asset('uploads/profile_pic/vendor/default.jpg')}}" alt="User profile picture">
                                @endif
                            </div>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Total Products</b> <a class="float-right">0</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Total Orders</b> <a class="float-right">0</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Total Sold Amount</b> <a class="float-right">0</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Wallet Balance</b> <a class="float-right">0</a>
                                </li>
                            </ul>
