                ...
                <div class="col-xl-12 col-wd-9gdot5">
                    <div id="content" class="site-content" tabindex="-1">
                        <div class="container">
                            ...
                            <nav class="woocommerce-breadcrumb" ><a href="{{route('shop')}}">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Featured Product</nav>
                                                    ...
                                                    <li class="product">
                                                        <div class="product-outer">
                                                            <div class="product-inner">
                                                                <span class="loop-product-categories"><a href="" rel="tag">{{$featured_product->category->name}}</a></span>
                                                                <a href="{{route('product-details',$featured_product->slug)}}">
                                                                    <h3>{{$featured_product->name}}</h3>
                                                                    <div class="product-thumbnail">
                                                                        <img href="{{route('product-details',$featured_product->slug)}}" src="{{url($featured_product->thumbnail_img)}}" alt="">
                                                                    </div>
                                                                </a>
                                                            ...
                                                            <span class="electro-price">
                                                                ...
                                                                @endif
                                                                    ...
                                                                    <a rel="nofollow" href="{{route('product-details',$featured_product->slug)}}" class="btn-add-cart btn-primary transition-3d-hover"><i class="ec ec-add-to-cart"></i></a>
...
@push('js')
    <script>
        function categoryFilter(category_id){
            ...
            $('.found_product').empty();
            $("#loader").show()
            $.get("{{url('/featured/category/products/')}}/"+category_id,
                function(data){
        ...
        function brandFilter(brand_id){
            ...
            $('.found_product').empty();
            $("#loader").show()
            $.get("{{url('/featured/brand/products/')}}/"+brand_id,
                function(data){
